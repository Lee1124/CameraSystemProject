  ...
  >
    <div class="delete-main">
      <div class="delete-tip">
        <span class="delete-tip1">是否确定删除该{{dataClass}}？</span>
        <span class="delete-tip2">• {{dataName}}{{tipText}}</span>
      </div>
      <div class="delete-bottom">
        <el-button type="text" class="btn-cancel" @click="handleClose">取消</el-button>
        <el-button class="btn-save" @click="confirmDelete">确认删除</el-button>
      </div>
    </div>
  </el-dialog>
</template>
...
<script>
export default {
  props: ["showDeleteDig", "dataName", "dataClass", "tipText"],
  methods: {
    /**
     * 关闭弹窗
     */
