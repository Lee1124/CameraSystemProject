<template>
  <div class="hotel-content">
    <div class="hotel-seach">
      <div class="seach-left">
        <div class="seach-select">
          ...
          <el-select v-model="searchParamet.CityId" size="small" clearable placeholder="请选择城市">
            <el-option
        ...
        <div class="seach-input">
          ...
          >
            <div class="search-div" slot="append" @click="getCameraHotelListInfo">
    ...
    <div class="hotel-table" ref="tableBox">
      <el-table
        :data="hotelList"
        stripe
        border
    ...
    <!--分页-->
    <div style="position: relative;bottom: -10px;left: 0px;right: 0;width:80.4%" class="clearfloat">
      <el-pagination
        background
    ...
    >
      <div class="edit-main">
        <div class="edit-item">
          <span class="span-title">城市：</span>
          <el-select v-model="editHotel.CityId" size="small" class="span-value" placeholder="请选择城市">
            <el-option
              v-for="city in cityData"
              :key="city.CityId"
              :label="city.CityName"
...
export default {
  ...
  methods: {
     ...
     * 获取酒店列表
     */
    getCameraHotelListInfo() {
      let that = this;
      this.$Axios({
        method: "POST",
        url: `${
          getkevalue().apiurl
        }/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/GetCameraHotelListInfo`,
        data: {
    ...
    addCameraHotelInfo(hotelInfo) {
      ...
      this.$Axios({
        ...
        url: `${
          getkevalue().apiurl
        }/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/AddCameraHotelInfo`,
        data: {
    ...
    deleteCameraHotelInfo(hotelId) {
      ...
      this.$Axios({
        ...
        url: `${
          getkevalue().apiurl
        }/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/DeleteCameraHotelInfo`,
        data: {
          HotelId: hotelId
        },
        success(res) {
