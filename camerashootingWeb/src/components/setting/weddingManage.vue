<template>
  <div class="wedding-content">
    <div class="wedding-seach">
      <div class="seach-left">
        ...
        <div class="seach-input">
          ...
          >
            <div class="search-div" slot="append" @click="getOrderWeddingInfo">
    ...
    <div class="wedding-table" ref="tableBox">
      <el-table
        :data="weddingList"
        stripe
        border
    ...
    <div style="position: relative;bottom: -10px;left: 0px;right: 0;width:80.4%" class="clearfloat">
      <el-pagination
        ...
        :total="weddingList.length "
        :page-size="15"
        @current-change="handleSizeChange"
        :current-page="searchParamet.PageIndex"
      ></el-pagination>
    </div>
  ...
  methods: {
    ...
    getOrderWeddingInfo() {
      ...
      this.$Axios({
        ...
        url: `${
          getkevalue().apiurl
        }/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/GetOrderWeddingInfo`,
        data: {
    ...
    addCameraWeedingInfo(weddingInfo, isDelete) {
      ...
      this.$Axios({
        ...
        url: `${
          getkevalue().apiurl
        }/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/AddCameraWeedingInfo`,
        data: {
