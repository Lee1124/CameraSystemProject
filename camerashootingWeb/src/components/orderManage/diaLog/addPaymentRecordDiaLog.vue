...
<script>
  ...
  let myMethods = {
    ...
    getDefaultData(obj){
      console.log(obj)
      // this.rowObj=obj;
      this.getRowNews(obj);//根据订单获取点开该行的信息
    },
    getRowNews(rowObj){
      let url = this.api + '/xlapi/CameraManage/AmountManage/AmountOrder/getamountlog';
      let data={
        id:rowObj.id
      };
      this.$Axios({
    ...
    /*获取类型*/
    getType(){
      let url = this.api + '/xlapi/CameraManage/AmountManage/AmountOrder/getamounttype';
      this.$Axios({
        method: 'GET',
        url: url,
        success(res) {
    ...
    /*获取账号*/
    getTNo(){
      let url = this.api + '/xlapi/CameraManage/AmountManage/AmountOrder/getamountinaddress';
      this.$Axios({
        method: 'GET',
        url: url,
        success(res) {
    ...
    addPaymentRequest(data){
      let url = this.api + '/xlapi/CameraManage/AmountManage/AmountOrder/addorderamount';
      this.$Axios({
        method: 'POST',
        url: url,
        data: data,
