...
<script>
  ...
  let myMethods = {
    ...
    //获取部门列表
    getDepartmentList() {
      let url = this.api + '/xlapi/CameraManage/CameraUserInfoManage/CameraUserInfo/GetBranchDepartmentList';
      let data = {
    ...
    //获取人员选择列表
    getPersonList() {
      let url = this.api + '/xlapi/CameraManage/CameraOrderInfoManage/CameraOrderInfo/GetUserInfoByDepartmentOrLikeName';
      let data = {
