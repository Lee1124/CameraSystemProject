      ...
      <el-table-column type="expand" prop="index" width="102" style="border: 1px solid" >
        <template slot-scope="props">
          <el-table
            ...
            border
            style="width: 100%"
            @selection-change="handleSelectionChangeSell"
            lazy>
            <el-table-column
              type="selection"
              width="40">
...
" style="color: #FF0000;cursor: pointer" >
      ...
      <el-table-column
        ...
        <template slot-scope="props">
          ...
          <span style="text-decoration: underline;color: #5996F8;cursor: pointer" @click="handlePayment(props.$index, props.row)">支付</span>
        </template>
      </el-table-column>
    </el-table>
    <!--分页-->
    ...
    <tip width="550px" :tip="tip" v-if="tip.dialogVisible">
      ...
      <div v-if="Statr_Index == 2" class="statr">
        <div class="clearfloat">
          ...
          <el-input style="width: 200px;float: left;    padding-left: 28px;" v-model="From.title" placeholder="请输入内容"></el-input>
        </div>
        <div class="clearfloat">
          <span style="float: left">应付金额:</span>
          <el-input style="width: 200px;float: left" v-model="From.title" placeholder="请输入内容"></el-input>
        </div>
        <div class="clearfloat" style="position: relative">
          <span style="float: left">实际支付:</span>
          <el-input style="width: 200px;float: left" v-model="From.title" placeholder="请输入内容"></el-input>
          <span style="position: absolute;
    right: 5px;color: #bbb">元</span>
        </div>
        <div class="clearfloat">
          <span style="float: left">账号:</span>
          <el-select style="float: left;width:190px;
height:32px;margin-right: 20px" v-model="From.type2" placeholder="">
            <el-option
        ...
        <div style="margin: 10px 0 " class="clearfloat">
          <span style="float: left;padding-right: 20px">说明:</span>
          <el-input  v-model="From.title"  type="textarea" style="resize: none;float: right;width: 85%;float: left;" placeholder="请输入内容"></el-input>
        </div>
      </div>
    </tip>
